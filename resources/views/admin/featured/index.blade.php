                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <a class="btn btn-success btn-flat  pull-right"
                           href="{{ url(PATH.'/featuredProduct/create') }}">Add</a>
                            ...
                            @foreach($featured as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url(PATH.'/featuredProduct/'.$row->id.'/edit') }}"
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form method="post" action="{{ url(PATH.'/featuredProduct/'.$row->id) }}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
