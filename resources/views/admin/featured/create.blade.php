    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-body">
                        <form action="{{ url(PATH.'/featuredProduct') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group col-md-3 @if($errors->has('code')) has-error @endif">
                                ...
                                <input name="x_translate" class="form-control" value="0">
                            </div>
                            <div class="form-group col-md-3 @if($errors->has('code')) has-error @endif">
                                <label>Y translate(move image from its origin in y diminution)</label>
                                <input name="y_translate" class="form-control" value="0">
                            </div>
