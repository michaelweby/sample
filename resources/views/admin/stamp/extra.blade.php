    ...
    $(document).ready(function () {
        ...
        function attr1(index,index2) {
            var temp='<div class="row form-group">'+
                ...
                '                <select required class="form-control attr12" data="attr'+index+index2+'">' +
                ...
                '            <div class="form-group col-sm-5">' +
                '                <label for="commission_type" class="control-label">Attribute <span class="text-red">*</span></label>' +
                '                <select required class="form-control attr" id="attr'+index+index2+'value" name="attrval['+index+'][]">' +
                '<option value="0" selected disabled>Select Attribute Value</option>'+
                '                </select>' +
                '</div>'+
        ...
        $(document).on('change','.attr12',function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $(ss).append('<option value="0" selected disabled>Select Attribute Value</option>');
