        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="{{url(PATH.'/shop') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group col-md-4">
                                <label>Vendor</label>
                                <select class="form-control select2" name="owner_id">
                                    @foreach($vendors as $vendor)
                                        <option @if(old('owner_id') == $vendor->id) selected @endif value="{{ $vendor->id }}"> {{ $vendor->first_name .' '.$vendor->last_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-4 @if($errors->has('commission_value')) has-error @endif" id="commission_value">
                                ...
                                <input type="text" name="commission_value" class="form-control" value="{{ old('commission_value') }}"
                            ...
                            <div class="form-group col-md-4 @if($errors->has('bank_account_name')) has-error @endif">
                                <label>Rate <sub>from 0 to 5</sub></label>
