                        ...
                        <div class="col-md-4 float-right p-0  mt-4  mb-3 head-component">
                            <div class="row" style="margin-right: 0;margin-left: 0;">
                                <div class="col-5 p-0  header-quick-views">
                                    <a href="<?php echo e(secure_url('cart')); ?>"><img src="<?php echo e(secure_asset('site_assets/img/cart.png')); ?>"><span class="num-info" id="cart-count"><?php echo e($cart_count); ?></span></a>
