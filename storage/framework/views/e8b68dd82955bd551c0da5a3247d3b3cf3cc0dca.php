        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="<?php echo e(secure_url(PATH.'/orders')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control" id="shipping_value" required value="<?php echo e($shipping_cost); ?>" name="shipping_value" type="number">
                            </div>
